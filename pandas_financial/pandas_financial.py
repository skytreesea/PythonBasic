import pandas as pd
df = pd.read_excel(r'C:\Users\ERC\Documents\GitHub\PythonBasic\pandas_financial\public_firms.xls')
...
#경상수지비율 원자료 
df2 = pd.read_excel(r'C:\Users\ERC\Documents\GitHub\PythonBasic\pandas_financial\financial.xlsx')
